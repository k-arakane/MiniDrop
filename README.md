...
MiniDrop is a minimal, fully transparent Drop-seq–style processing pipeline designed for educational and exploratory use.  
...
- `pg_004_01_create_fastq.sh` — generate minimal FASTQ files  
- `pg_005_02_cellbarcode_tag.sh` — attach cell barcode  
- `pg_006_01_star__________wREF.sh` — align reads to MYC reference  
- `pg_008_01_counts.sh` — generate final count table  
...
👉 **[MiniDrop Tutorial (HTML)](https://keita-iida.github.io/MiniDrop/docs/tutorial_minidrop.html)**
